...
const Contact = ({ resume: { resume, loading }, fetchResume, sendEmail }) => {
	useEffect(() => {
		fetchResume();
	}, [fetchResume]);
...
export default connect(mapStateToProps, { fetchResume, sendEmail })(Contact);
